...
image_folder = 'data/PersonOnly/images'
...
for xml_file in glob.iglob(f'{image_folder}/*.xml', recursive=True):

    print('Running inference for {}... '.format(xml_file), end='')

    image_np = load_image_into_numpy_array(xml_file)
