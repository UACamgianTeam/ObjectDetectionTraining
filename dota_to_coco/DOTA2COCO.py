""" Takes a dota dataset and creates a coco-json file for them 
(Should do this twice: once for training set and once for validation set)

Slightly modified version from the DOTA_devkit: https://github.com/CAPTAIN-WHU/DOTA_devkit

Example usage: ./DOTA2COCO.py ./path/to/dota_dataset ./path/to/new/coco.json
"""
...
if __name__ == '__main__':
    if sys.argv and len(sys.argv) == 3:
        DOTA2COCO(sys.argv[1], sys.argv[2])
    else:
        print('Incorrect argument format.')
        print('Correct argument format: ./DOTA2COCO.py ./path/to/dataset ./path/to/new/coco.json')