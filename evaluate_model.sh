...
then
  ...
  ORIGINAL_MODEL_DIR="${OBJECTDETECTIONTRAINING_REPO}/models/original_models/ssd_mobilenet_v2_fpnlite_640x640_coco17_tpu-8"
  RETRAINED_MODEL_DIR="${OBJECTDETECTIONTRAINING_REPO}/models/retrained_models/my_ssd_mobilenet_v2_fpnlite"
else
