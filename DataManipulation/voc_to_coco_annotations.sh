...
python3 voc_to_coco_annotations.py \
--ann_paths_list ../data/PEViD-UHD/fighting_day_indoor_3/annotations/annpaths_list.txt \
--labels ../data/PEViD-UHD/labels.txt \
--output_file ../data/PEViD-UHD/fighting_day_indoor_3/annotations/fighting_day_indoor_3.json
